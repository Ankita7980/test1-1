...
/**
 * its conatins webdriver specific resulibilty actions
 * @author aman
 *
 */
...
/**
 * used to wait for element to be clickable in GUI and check the specific element for every 500 miliseconds
 */
